...
public class CompanyProtocol implements ApplProtocol {
    ...
    public Response getResponse(Request request) {
        ...
        try {
            ...
            Method method = this.getClass().getDeclaredMethod(methodName, Serializable.class);
 ...
 // This method is invoked dynamically using reflection. The IDE might flag it as unused, but it is used.
